...
description.style.cssText = 'max-width: 80%; font-variant: small-caps; text-align: center; font-size: 26px;'
imgPack.style.cssText = 'padding: 40px 0px 20px 0px; width: 95%; display: flex; justify-content: center; flex-direction: column'
const imgRowVisible = 'height: 25vh; display: flex; flex-direction: row; justify-content: center; margin: 5px'
