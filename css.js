...
//main
main.style.cssText = 'width:90%; display:flex; align-items: center; justify-content: center; padding: 20px 0; flex-direction: column; background: rgba(192, 192, 192, 0.49);border-radius: 20px; box-shadow: 0px 3px 59px 16px rgba(77, 77, 77, 0.74);'
